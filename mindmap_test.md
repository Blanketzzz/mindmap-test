...
A([Convex Optimization Theory]):::root
...
classDef root fill:#FDE68A,stroke:#B45309,color:#111827,stroke-width:2px;
classDef blue fill:#93C5FD,stroke:#1D4ED8,color:#111827;
classDef purple fill:#C4B5FD,stroke:#6D28D9,color:#111827;
classDef gray fill:#D1D5DB,stroke:#4B5563,color:#111827;
classDef orange fill:#FDBA74,stroke:#C2410C,color:#111827;
classDef red fill:#FCA5A5,stroke:#DC2626,color:#111827;
